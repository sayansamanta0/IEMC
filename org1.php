    ...
    <div class="container main_content">
        ...
        <div class="two">
            ...
            <center>
                ...
                <div class="card" style="width: 20rem;height :10 rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p>Haldia Institute of Technology ,India</p>
                    </div>
                </div>
            </center>
            <br>
            ...
            <div class="patron">
                ...
                <div class="card1">
                    <img class="card-img1" src="src/6.jpg">
                    <div class="card-body">
    ...
    <center>
        <div class="organizing_commitee">
            ...
            <div class="container1">
                <div class="card2">
                    <img class="card-img2" src="src/9.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/16.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/15.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/sarbari.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/Photo_mihir.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/5.jpg">
                    <div class="card-body">
            ...
            <div class="container1">
                <div class="card2">
                    <img class="card-img2" src="src/apratim.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/PPanja.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/anupam.jpg">
                    <div class="card-body">
                        <h6><b>Anupam De</b></h6>
                        <p class="card-text">Haldia Institute of Technology ,India</p>
                    </div>
                ...
                <div class="card2">
                    <img class="card-img2" src="src/manoj.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/biplab.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/bidesh.jpg">
                    <div class="card-body">
            ...
            <div class="container1">
                <div class="card2">
                    <img class="card-img2" src="src/barman.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/sumana.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/AMukherjee.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/SKMaity.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/Kousik Maity.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/Pradip Mandal.jpg">
                    <div class="card-body">
            ...
            <div class="container1">
                <div class="card2">
                    <img class="card-img2" src="src/GMSarkar.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/Subrata Panja.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/Susmita Sarkar.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/Sabyasachi Samanta.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/Soumen Ghosh.jpeg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/Sudipta Roy.jpeg">
                    <div class="card-body">
            ...
            <div class="container1">
                <div class="card2">
                    <img class="card-img2" src="src/Ashok Kumar Mondal.jpeg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/Rajesh Mukherjee.jpeg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/shatadru sengupta.jpeg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/Debasis Das Adhikary.jpeg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/akpuja.jpg">
                    <div class="card-body">
                ...
                <div class="card2">
                    <img class="card-img2" src="src/DKJ.jpg">
                    <div class="card-body">
                        <h6 class="sir" style="font-size: 15px;"><b>Dipak Kumar Jana (Organizing Chair)</b></h6>
                        <p class="card-text" style="font-size: 10px;">Haldia Institute of Technology ,India</p>
                    </div>
                </div>
